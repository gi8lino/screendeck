...
RUN install -d -o 0 -g 0 -m 2775 /outfs/work /outfs/data /outfs/tmp

# Use distroless as minimal base image to package the application binary.
# Refer to https://github.com/GoogleContainerTools/distroless for more details.
FROM gcr.io/distroless/static:nonroot

COPY --from=prep /workspace/screendeck /screendeck
COPY --from=prep /outfs/work /work
COPY --from=prep /outfs/data /data
