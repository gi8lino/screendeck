...
<p align="center">
  <img src="screenshots/room.png" alt="ScreenDeck demo room with Alice and Bob" width="1000" />
</p>

!!! tip "New to ScreenDeck?"
Start with [Deployment](deployment.md) to run ScreenDeck, then check [Configuration](configuration.md) for the settings you can customize.
...
- :material-cog-outline:{ .lg .middle } **Configuration**
  ...
  ***
  ...
  [:octicons-arrow-right-24: Configure ScreenDeck](configuration.md)
